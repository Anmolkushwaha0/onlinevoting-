<%-- 
    Document   : REGISTRATION OF CANDIDATE
    Created on : 8 Dec, 2022, 10:37:46 AM
...
<html>
 ...
 .anmol input[type = "submit"]:hover{
    ...
    <body>
        <form id="form1" name="form1" method="post" class="anmol" action="RCDATA.jsp">
            <table>
    <%
      ...
      %>
        ...
        <input type="text" name="FA" placeholder="Fathername">
        <input type="text" name="MA" placeholder="Mathername">
        <input type="text" name="ADD" placeholder="Address">
        <input type="text" name="PH" placeholder="phone_no">
        <input type="text" name="DOB"placeholder="Date of birth">
        <input type="text" name="EM"placeholder="Email_id">
        <input type="text" name="ADH"placeholder="Aadhaar">
        <input type="text" name="FM" placeholder="FamilyMembers">
        <a href="home.jsp"><input type="submit" name="submit"  value="submit"></a>
